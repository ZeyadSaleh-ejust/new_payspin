...
class Home02ListWidget extends StatefulWidget {
  const Home02ListWidget({super.key});

  static String routeName = 'Home02List';
  static String routePath = '/home02List';

  @override
  State<Home02ListWidget> createState() => _Home02ListWidgetState();
}
...
class _Home02ListWidgetState extends State<Home02ListWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Home02List'});
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'apm7yk42' /* Payspin Hottest updates */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: AutoSizeText(
                                  FFLocalizations.of(context).getText(
                                    'trgvpx34' /* Retreat to the natural beauty ... */,
                                  ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'unsq06cs' /* Little Mountain House */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .headlineSmall
                                      .override(
                              ...
                              Padding(
                                ...
                                child: AutoSizeText(
                                  FFLocalizations.of(context).getText(
                                    '630v0tzp' /* Escape to the serene beauty of... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: AutoSizeText(
                                  FFLocalizations.of(context).getText(
                                    '4brsigd9' /* Escape to the serene beauty of... */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
