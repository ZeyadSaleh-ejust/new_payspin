...
import 'app_values_component2_model.dart';
export 'app_values_component2_model.dart';

class AppValuesComponent2Widget extends StatefulWidget {
  const AppValuesComponent2Widget({super.key});

  @override
  State<AppValuesComponent2Widget> createState() =>
      _AppValuesComponent2WidgetState();
}

class _AppValuesComponent2WidgetState extends State<AppValuesComponent2Widget>
    with TickerProviderStateMixin {
  late AppValuesComponent2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppValuesComponent2Model());
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '8jpzbhyt' /* You will find a money circle f... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineMedium
                      ...
                      Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: GradientText(
                                    FFLocalizations.of(context).getText(
                                      'naihzq31' /* How do you name your money cir... */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .displaySmall
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                '9tixape8' /* Because we know it is traditio... */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .headlineMedium
                    ...
                    children: [
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: GradientText(
                            FFLocalizations.of(context).getText(
                              'u3y9aq6h' /* Looking for money circle? */,
                            ),
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .displaySmall
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '8wwwxgi1' /* We connect you with an extende... */,
                          ),
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context)
                              .headlineMedium
