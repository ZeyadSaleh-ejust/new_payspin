                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'ONBOARDING01_PAGE_Text_ndf5zz3s_ON_TAP');
                              logFirebaseEvent('Text_navigate_to');

                              context.pushNamed(Auth1PhoneWidget.routeName);
                            },
                            child: Text(
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'ke7wkmir' /* Thanks for joining! Access or ... */,
                              ),
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ONBOARDING01_PAGE_ABOUT_US_BTN_ON_TAP');
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ONBOARDING01_PAGE_GET_STARTED_BTN_ON_TAP');
                                  logFirebaseEvent('Button_navigate_to');
